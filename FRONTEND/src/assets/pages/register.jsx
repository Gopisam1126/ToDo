                ...
                <form>
                    <div className="input-c">
                        <div className="f-l-name-c">
                            <div>
                                ...
                                <div className="firstname-i-c">
                                    <input type="text" name="firstname" placeholder="eg: John" className="firstname-i login-i" autoComplete="off" required /><BadgeIcon style={{
                                        position: "relative",
                                        top: "1.1rem",
                                        left: "-4.5rem"
                                    }}/>
                            ...
                            <div>
                                ...
                                <div className="lastname-i-c">
                                    <input type="text" name="lastname" placeholder="eg: Doe" className="lastname-i login-i" autoComplete="off" required /><BadgeIcon style={{
                                        position: "relative",
                                        top: "1.1rem",
                                        left: "-4.5rem"
                                    }}/>
                        ...
                        <div className="username">
                            <label htmlFor="lastname" className="last-name login-labels">username</label><br />
                            <div className="username-i-c">
                                <input type="text" name="setusername" placeholder="eg: john_Doe123" className="username-i login-i" autoComplete="off" required /><BadgeIcon style={{
                                    position: "relative",
                                    top: "1.1rem",
                                    left: "-4.5rem"
                                }}/>
